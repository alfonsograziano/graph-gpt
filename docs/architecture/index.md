...
- [Graph-GPT Fullstack Architecture Document](#table-of-contents)
  ...
  - [Components](./components.md)
    ...
    - [Graph State Management](./components.md#graph-state-management)
    - [LLM Integration Service](./components.md#llm-integration-service)
  - [External APIs](./external-apis.md)
    - [OpenAI API](./external-apis.md#openai-api)
  - [Core Workflows](./core-workflows.md)
    - [Conversation Creation and Node Interaction](./core-workflows.md#conversation-creation-and-node-interaction)
    - [Graph State Synchronization](./core-workflows.md#graph-state-synchronization)
